...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Widget.List.CollapsibleGroupsBehavior+ICollapseGroupListenerImplementor, Telerik.Xamarin.Android.List", CollapsibleGroupsBehavior_CollapseGroupListenerImplementor.class, __md_methods);
	}
	...
	public CollapsibleGroupsBehavior_CollapseGroupListenerImplementor ()
	{
		...
		if (getClass () == CollapsibleGroupsBehavior_CollapseGroupListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Widget.List.CollapsibleGroupsBehavior+ICollapseGroupListenerImplementor, Telerik.Xamarin.Android.List", "", this, new java.lang.Object[] {  });
	}
