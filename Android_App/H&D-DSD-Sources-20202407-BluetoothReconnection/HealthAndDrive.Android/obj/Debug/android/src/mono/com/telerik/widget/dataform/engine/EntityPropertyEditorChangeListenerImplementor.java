...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Widget.Dataform.Engine.IEntityPropertyEditorChangeListenerImplementor, Telerik.Xamarin.Android.Input", EntityPropertyEditorChangeListenerImplementor.class, __md_methods);
	}
	...
	public EntityPropertyEditorChangeListenerImplementor ()
	{
		...
		if (getClass () == EntityPropertyEditorChangeListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Widget.Dataform.Engine.IEntityPropertyEditorChangeListenerImplementor, Telerik.Xamarin.Android.Input", "", this, new java.lang.Object[] {  });
	}
