...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Widget.Dataform.Visualization.Core.EntityPropertyEditor+IOnValidationEventListenerImplementor, Telerik.Xamarin.Android.Input", EntityPropertyEditor_OnValidationEventListenerImplementor.class, __md_methods);
	}
	...
	public EntityPropertyEditor_OnValidationEventListenerImplementor ()
	{
		...
		if (getClass () == EntityPropertyEditor_OnValidationEventListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Widget.Dataform.Visualization.Core.EntityPropertyEditor+IOnValidationEventListenerImplementor, Telerik.Xamarin.Android.Input", "", this, new java.lang.Object[] {  });
	}
